    ...
    b("jquery", function () {
        ...
        function b() {
            ...
            this.destroyed = !1, this.__popup = c("<div />").css({
                ...
                position: "absolute",
                outline: 0
            }).attr("tabindex", "-1").html(this.innerHTML).appendTo(addbox), this.__backdrop = this.__mask = c("<div />").css({
                opacity: .7,
                background: "#000"
        ...
        return c.extend(b.prototype, {
            ...
            __focus: function (a) {
                try {
                    this.autofocus && !/^iframe$/i.test(a.nodeName)
        ...
        var g = 0,
			...
			l = function (a, c, d) {
			    ...
			    var f = a.id = a.id || h + g,
					i = l.get(f);
			    return i ? i.focus() : (k || (a.fixed = !1), a.quickClose && (a.modal = !0), b.isArray(a.button) || (a.button = []), void 0 !== d && (a.cancel = d), a.cancel && a.button.push({
			        id: "cancel",
			        value: a.cancelValue,
			        callback: a.cancel,
        ...
        return l.create = function (a) {
            ...
            }), this._$("dialog").addClass(this.skin), thisskin = this.skin, this._$("body").css("padding", this.padding), a.quickClose && f.on("onmousedown" in document ? "mousedown" : "click", function () {
                
                if (!$('.ui-popup.ui-popup-modal').find('.htmlDialog').hasClass('OffdialogFalse')) {
